...
void suma()//Funcion para sumar matrices
{
	int m1[3][3];
	int m2[3][3];
	int mf[3][3];
...
void resta()//Funcion para restar matrices
{
	int m1[3][3];
	int m2[3][3];
	int mf[3][3];
...
void multiplicacion()//Funcion para multiplicar matrices
{	
	int i,j,k;
	int matrizA[3][3];
	int matrizB[3][3];
...
void menu()//Función en la cual hay un menú de opciones y en cada opción se llama a cada funcion
{
	int op;
   printf("\n1.-Suma\n2.-Resta\n3.-Multiplicaci%cn\n4.-Salir\n",162);
   scanf("%d", &op);
